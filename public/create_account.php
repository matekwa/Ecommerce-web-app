...
<head>
 ...
 <style type="text/css">
      ...
      #error-msg .fas{color: #ea4335 !important;}
      #er .fas{color: #ea4335 !important;}
      #valid-msg{color: #34a853;}
      #valid-msg .fas{color: #34a853;}
    </style>
<body>
<main>
...
<script type="text/javascript">
   let input = document.querySelector("#phone_number");
        ...
        var ErrorMap = ["<i class='fas fa-exclamation-circle'>&nbsp;</i>Invalid Number!","<i class='fas fa-exclamation-circle'>&nbsp;</i>Invalid Country Code!","<i class='fas fa-exclamation-circle'>&nbsp;</i>Too Short!","<i class='fas fa-exclamation-circle'>&nbsp;</i>Too Long!"];
...
<script type="text/javascript" src="../resources/create_account.js"></script>
</html>